...
// import { SmartTimeline } from '../state/smart/Timeline';
import { SmartLuciditvTimeline } from '../state/smart/LuciditvTimeline';
...
function ActiveCallManager({
  ...
  return (
    <>
      <div className="luciditv-module-call-manager">
        <SmartLuciditvTimeline key={conversation.id} id={conversation.id} />
      </div>
      <CallScreen
        activeCall={activeCall}
...
export function LuciditvCallManager({
  acceptCall,
  activeCall,
  approveUser,
  availableCameras,

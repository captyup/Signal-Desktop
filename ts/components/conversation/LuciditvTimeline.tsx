...
export class LuciditvTimeline extends React.Component<
  PropsType,
  StateType,
  SnapshotType
> {
  ...
  public override render(): JSX.Element | null {
    ...
    for (
      ...
      // }
      const unreadIndicatorPlacement = UnreadIndicatorPlacement.JustBelow;
    ...
    const warning = LuciditvTimeline.getWarning(this.props, this.state);
            ...
            >
              ...
              >
                ...
                >
                  {/* {haveOldest && ( */}
                  {/*   <> */}
                  {/*     {LuciditvTimeline.getWarning(this.props, this.state) && ( */}

...
import { LuciditvListTile } from '../LuciditvListTile';
...
export const LuciditvContactListItem: FunctionComponent<PropsType> = React.memo(
  function LuciditvContactListItem({
    about,
    acceptedMessageRequest,
    avatarUrl,
    badge,

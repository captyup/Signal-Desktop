...
import { LuciditvChatsTab } from '../../components/LuciditvChatsTab';
import { SmartLuciditvLeftPane } from './LuciditvLeftPane';
...
function renderLeftPane(props: NavTabPanelProps) {
  return <SmartLuciditvLeftPane {...props} />;
}
...
export const SmartLuciditvChatsTab = memo(function SmartChatsTab() {

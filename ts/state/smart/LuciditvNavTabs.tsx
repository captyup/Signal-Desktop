...
import type { NavTabPanelProps } from '../../components/LuciditvNavTabs';
...
import { LuciditvNavTabs } from '../../components/LuciditvNavTabs';
...
export const SmartLuciditvNavTabs = memo(function SmartNavTabs({
  navTabsCollapsed,

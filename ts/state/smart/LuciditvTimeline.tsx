...
import { LuciditvTimeline } from '../../components/conversation/LuciditvTimeline';
...
import {
  ...
  type SmartLuciditvTimelineItemProps,
...
export const SmartLuciditvTimeline = memo(function SmartTimeline({
  id,
}: ExternalProps) {

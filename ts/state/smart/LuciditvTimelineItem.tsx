...
import { LuciditvTimelineItem } from '../../components/conversation/LuciditvTimelineItem';

export type SmartLuciditvTimelineItemProps = {
...
export const SmartLuciditvTimelineItem = memo(
  function SmartLuciditvTimelineItem(
    props: SmartLuciditvTimelineItemProps
  ): JSX.Element {
    const {
      containerElementRef,
